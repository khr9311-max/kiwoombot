# ---
# api_id: usa20941
# api_name: 미국주식 누적 등락률 상위(ETF)
# category: 미국주식
# sub_category: 순위정보
# template: rest
# api_url: /api/us/rkinfo
# menu_path: 미국주식 > 순위정보 > 미국주식 누적 등락률 상위(ETF)(usa20941)
# ---
...
def get_overseas_cumulative_change_rate_top_etf(
    stex_tp: str | None = '0',
    etf_cat1: str | None = '',
    etf_cat2: str | None = '',
    sort_tp: str | None = '0',
    pric_cnd1: str | None = '-100',
    pric_cnd2: str | None = '100',
    base_dt: str | None = '20260410',
    stk_cnd: str | None = '0',
    ...
    """
    미국주식 누적 등락률 상위(ETF)[usa20941] API를 호출합니다.
    ...
    Args:
        ...
        sort_tp: 정렬기준구분 — 0:상승률,1:상승폭,3:하락률,4:하락폭
        pric_cnd1: 가격1 구분
        pric_cnd2: 가격2 구분
    ...
    Example:
        >>> result = get_overseas_cumulative_change_rate_top_etf(
        ...     stex_tp='0',
        ...     etf_cat1='',
        ...     etf_cat2='',
        ...     sort_tp='0',
    ...
    if pric_cnd1 is not None:
        body["pric_cnd1"] = pric_cnd1  # 가격1 구분
    if pric_cnd2 is not None:
        body["pric_cnd2"] = pric_cnd2  # 가격2 구분
