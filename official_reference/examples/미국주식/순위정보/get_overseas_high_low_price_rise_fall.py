# ---
# api_id: usa24110
# api_name: 미국주식 최고최저가대비 상승하락(주식/업종)
# category: 미국주식
# sub_category: 순위정보
# template: rest
# api_url: /api/us/rkinfo
# menu_path: 미국주식 > 순위정보 > 미국주식 최고최저가대비 상승하락(주식/업종)(usa24110)
# ---
...
def get_overseas_high_low_price_rise_fall(
    stex_tp: str | None = '0',
    inds_cd: str | None = '',
    stk_tp: str | None = '0',
    sort_tp: str | None = '0',
    ...
    """
    미국주식 최고최저가대비 상승하락(주식/업종)[usa24110] API를 호출합니다.
    ...
    Example:
        >>> result = get_overseas_high_low_price_rise_fall(
        ...     stex_tp='0',
        ...     inds_cd='',
        ...     stk_tp='0',
        ...     sort_tp='0',
