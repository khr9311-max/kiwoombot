# ---
# api_id: usa24121
# api_name: 미국주식 특정일자 상승/하락(ETF)
# category: 미국주식
# sub_category: 순위정보
# template: rest
# api_url: /api/us/rkinfo
# menu_path: 미국주식 > 순위정보 > 미국주식 특정일자 상승/하락(ETF)(usa24121)
# ---
...
def get_overseas_rise_fall_by_date_etf(
    stex_tp: str | None = '0',
    etf_cat1: str | None = '',
    etf_cat2: str | None = '',
    stk_cnd: str | None = '0',
    ...
    base_dt: str | None = '20260508',
    sort_tp: str | None = '0',
) -> dict[str, pd.DataFrame]:
    """
    미국주식 특정일자 상승/하락(ETF)[usa24121] API를 호출합니다.
    ...
    Args:
        ...
        base_dt: 기간 — YYYYMMDD
        sort_tp: 정렬기준 구분 — 0:상승,2:하락

    Returns:
        API 응답 데이터입니다.

    Example:
        >>> result = get_overseas_rise_fall_by_date_etf(
        ...     stex_tp='0',
        ...     etf_cat1='',
        ...     etf_cat2='',
        ...     stk_cnd='0',
