# ---
# api_id: usa24162
# api_name: 미국주식 연속상승/하락 순위(관심종목)
# category: 미국주식
# sub_category: 순위정보
# template: rest
# api_url: /api/us/rkinfo
# menu_path: 미국주식 > 순위정보 > 미국주식 연속상승/하락 순위(관심종목)(usa24162)
# ---
...
def get_overseas_consecutive_rise_fall_rank_watchlist(
    stex_tp: str | None = '0',
    ...
    """
    미국주식 연속상승/하락 순위(관심종목)[usa24162] API를 호출합니다.
    ...
    Args:
        ...
        sort_tp: 정렬기준 — 0:연속일수상승,1:연속일수보합,2:연속일수하락,3:기준일대비상승,4:기준일대비보합,5:기준일대비 하락

    Returns:
        API 응답 데이터입니다.

    Example:
        >>> result = get_overseas_consecutive_rise_fall_rank_watchlist(
        ...     stex_tp='0',
