# ---
# api_id: usa24290
# api_name: 미국주식 주간거래 괴리율 상위(주식/업종)
# category: 미국주식
# sub_category: 순위정보
# template: rest
# api_url: /api/us/rkinfo
# menu_path: 미국주식 > 순위정보 > 미국주식 주간거래 괴리율 상위(주식/업종)(usa24290)
# ---
...
def get_overseas_day_session_disparity_top(
    stex_tp: str | None = '',
    inds_cd: str | None = '',
    inds_cls_tp: str | None = '',
    stk_tp: str | None = '',
    stk_cnd: str | None = '',
    pric_cnd: str | None = '',
    trde_qty_tp: str | None = '',
    trde_prica_cnd: str | None = '',
    sort_tp: str | None = '',
) -> dict[str, pd.DataFrame]:
    """
    미국주식 주간거래 괴리율 상위(주식/업종)[usa24290] API를 호출합니다.
    ...
    Args:
        ...
        inds_cls_tp: 해외주식업종분류구분 — stk_tp(종목구분):0일 경우, 0:전체,1:다우30,2:나스닥100,3:S&P500
        ...
        sort_tp: 정렬기준 구분 — 0:상승률,1:상승폭,2:보합,3:하락율,4:하락폭

    Returns:
        API 응답 데이터입니다.

    Example:
        >>> result = get_overseas_day_session_disparity_top(
        ...     stex_tp='',
        ...     inds_cd='',
        ...     inds_cls_tp='',
        ...     stk_tp='',
    ...
    if inds_cls_tp is not None:
        body["inds_cls_tp"] = inds_cls_tp  # 해외주식업종분류구분
