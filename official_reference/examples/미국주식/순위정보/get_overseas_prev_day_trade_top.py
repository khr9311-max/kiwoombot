# ---
# api_id: usa20960
# api_name: 미국주식 전일 거래상위(주식/업종)
# category: 미국주식
# sub_category: 순위정보
# template: rest
# api_url: /api/us/rkinfo
# menu_path: 미국주식 > 순위정보 > 미국주식 전일 거래상위(주식/업종)(usa20960)
# ---
...
def get_overseas_prev_day_trade_top(
    stex_tp: str | None = '0',
    inds_cd: str | None = '',
    stk_tp: str | None = '0',
    qry_tp: str | None = '0',
    ...
    """
    미국주식 전일 거래상위(주식/업종)[usa20960] API를 호출합니다.
    ...
    Example:
        >>> result = get_overseas_prev_day_trade_top(
        ...     stex_tp='0',
        ...     inds_cd='',
        ...     stk_tp='0',
        ...     qry_tp='0',
