# ---
# api_id: usa20551
# api_name: 미국주식 시가총액상위(ETF)
# category: 미국주식
# sub_category: 순위정보
# template: rest
# api_url: /api/us/rkinfo
# menu_path: 미국주식 > 순위정보 > 미국주식 시가총액상위(ETF)(usa20551)
# ---
...
def get_overseas_market_cap_top_etf(
    stex_tp: str | None = '0',
    etf_cat1: str | None = '',
    etf_cat2: str | None = '',
    ...
    """
    미국주식 시가총액상위(ETF)[usa20551] API를 호출합니다.
    ...
    Example:
        >>> result = get_overseas_market_cap_top_etf(
        ...     stex_tp='0',
        ...     etf_cat1='',
        ...     etf_cat2='',
        ...     trde_qty_tp='0',
