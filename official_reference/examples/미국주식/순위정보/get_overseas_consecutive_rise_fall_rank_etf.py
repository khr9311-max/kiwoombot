# ---
# api_id: usa24161
# api_name: 미국주식 연속상승/하락 순위(ETF)
# category: 미국주식
# sub_category: 순위정보
# template: rest
# api_url: /api/us/rkinfo
# menu_path: 미국주식 > 순위정보 > 미국주식 연속상승/하락 순위(ETF)(usa24161)
# ---
...
def get_overseas_consecutive_rise_fall_rank_etf(
    stex_tp: str | None = '0',
    etf_cat1: str | None = '',
    etf_cat2: str | None = '',
    ...
    """
    미국주식 연속상승/하락 순위(ETF)[usa24161] API를 호출합니다.
    ...
    Example:
        >>> result = get_overseas_consecutive_rise_fall_rank_etf(
        ...     stex_tp='0',
        ...     etf_cat1='',
        ...     etf_cat2='',
        ...     trde_qty_tp='0',
