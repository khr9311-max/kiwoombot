# ---
# api_id: usa20922
# api_name: 미국주식 시가대비 등락률상위(관심종목)
# category: 미국주식
# sub_category: 순위정보
# template: rest
# api_url: /api/us/rkinfo
# menu_path: 미국주식 > 순위정보 > 미국주식 시가대비 등락률상위(관심종목)(usa20922)
# ---
...
def get_overseas_change_rate_top_vs_open_watchlist(
    stex_tp: str | None = '0',
    ...
    """
    미국주식 시가대비 등락률상위(관심종목)[usa20922] API를 호출합니다.
    ...
    Args:
        ...
        sort_tp: 정렬기준 — 1:상승률, 2:하락률
        stk_tp: 종목구분 — 0:전체,1:주식,2:ETF
    ...
    Example:
        >>> result = get_overseas_change_rate_top_vs_open_watchlist(
        ...     stex_tp='0',
