# ---
# api_id: usa24150
# api_name: 미국주식 회전율 상위(주식/업종)
# category: 미국주식
# sub_category: 순위정보
# template: rest
# api_url: /api/us/rkinfo
# menu_path: 미국주식 > 순위정보 > 미국주식 회전율 상위(주식/업종)(usa24150)
# ---
...
def get_overseas_turnover_rate_top(
    stex_tp: str | None = '0',
    inds_cd: str | None = '',
    ...
    """
    미국주식 회전율 상위(주식/업종)[usa24150] API를 호출합니다.
    ...
    Example:
        >>> result = get_overseas_turnover_rate_top(
        ...     stex_tp='0',
        ...     inds_cd='',
        ...     trde_qty_tp='0',
        ...     stk_tp='0',
