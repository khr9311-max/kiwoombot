# ---
# api_id: usa20880
# api_name: 키움 거래 상위 종목(미국주식)
# category: 미국주식
# sub_category: 순위정보
# template: rest
# api_url: /api/us/rkinfo
# menu_path: 미국주식 > 순위정보 > 키움 거래 상위 종목(미국주식)(usa20880)
# ---
...
def get_overseas_kiwoom_trade_top(
    qry_tp: str | None = '7',
    dt_unit_tp: str | None = '8',
) -> dict[str, pd.DataFrame]:
    """
    키움 거래 상위 종목(미국주식)[usa20880] API를 호출합니다.
    ...
    Example:
        >>> result = get_overseas_kiwoom_trade_top(
        ...     qry_tp='7',
        ...     dt_unit_tp='8',
        ... )
