# ---
# api_id: usa24111
# api_name: 미국주식 최고최저가대비 상승하락(ETF)
# category: 미국주식
# sub_category: 순위정보
# template: rest
# api_url: /api/us/rkinfo
# menu_path: 미국주식 > 순위정보 > 미국주식 최고최저가대비 상승하락(ETF)(usa24111)
# ---
...
def get_overseas_high_low_price_rise_fall_etf(
    stex_tp: str | None = '0',
    etf_cat1: str | None = '',
    etf_cat2: str | None = '',
    sort_tp: str | None = '0',
    ...
    """
    미국주식 최고최저가대비 상승하락(ETF)[usa24111] API를 호출합니다.
    ...
    Args:
        ...
        sort_tp: 정렬기준구분 — 0:저가대비상승,1:고가대비하락
        dt_tp: 기간구분 — 0:연중,1:52주
    ...
    Example:
        >>> result = get_overseas_high_low_price_rise_fall_etf(
        ...     stex_tp='0',
        ...     etf_cat1='',
        ...     etf_cat2='',
        ...     sort_tp='0',
