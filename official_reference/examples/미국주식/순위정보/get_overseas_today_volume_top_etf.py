# ---
# api_id: usa20531
# api_name: 미국주식 당일 거래량 상위(ETF)
# category: 미국주식
# sub_category: 순위정보
# template: rest
# api_url: /api/us/rkinfo
# menu_path: 미국주식 > 순위정보 > 미국주식 당일 거래량 상위(ETF)(usa20531)
# ---
...
def get_overseas_today_volume_top_etf(
    stex_tp: str | None = '0',
    etf_cat1: str | None = '',
    etf_cat2: str | None = '',
    ...
    """
    미국주식 당일 거래량 상위(ETF)[usa20531] API를 호출합니다.
    ...
    Args:
        ...
        qry_tp: 정렬기준 구분 — 0:거래량상위,1:거래대금상위,2:거래회전율상위
    ...
    Example:
        >>> result = get_overseas_today_volume_top_etf(
        ...     stex_tp='0',
        ...     etf_cat1='',
        ...     etf_cat2='',
        ...     trde_qty_tp='0',
