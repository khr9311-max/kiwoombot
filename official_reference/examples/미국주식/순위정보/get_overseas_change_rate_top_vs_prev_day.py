# ---
# api_id: usa20910
# api_name: 미국주식 전일대비 등락률상위(주식/업종)
# category: 미국주식
# sub_category: 순위정보
# template: rest
# api_url: /api/us/rkinfo
# menu_path: 미국주식 > 순위정보 > 미국주식 전일대비 등락률상위(주식/업종)(usa20910)
# ---
...
def get_overseas_change_rate_top_vs_prev_day(
    stex_tp: str | None = '0',
    inds_cd: str | None = '',
    inds_cls_tp: str | None = '0',
    sort_tp: str | None = '1',
    stk_tp: str | None = '0',
    stk_cnd: str | None = '0',
    pric_cnd: str | None = '0',
    ...
    """
    미국주식 전일대비 등락률상위(주식/업종)[usa20910] API를 호출합니다.
    ...
    Args:
        ...
        inds_cls_tp: 미국업종구분 — stk_tp(종목구분): 0일경우, 0:전체,1:다우30,2:나스닥100,3:S&P500
        sort_tp: 정렬기준 — 1:전일대비 상승률, 2:전일대비 상승폭 3: 보합 4:전일대비 하락률 5:전일대비 하락폭
    ...
    Example:
        >>> result = get_overseas_change_rate_top_vs_prev_day(
        ...     stex_tp='0',
        ...     inds_cd='',
        ...     inds_cls_tp='0',
        ...     sort_tp='1',
    ...
    if inds_cls_tp is not None:
        body["inds_cls_tp"] = inds_cls_tp  # 미국업종구분
