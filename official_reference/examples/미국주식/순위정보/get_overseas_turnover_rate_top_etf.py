# ---
# api_id: usa24151
# api_name: 미국주식 회전율 상위(ETF)
# category: 미국주식
# sub_category: 순위정보
# template: rest
# api_url: /api/us/rkinfo
# menu_path: 미국주식 > 순위정보 > 미국주식 회전율 상위(ETF)(usa24151)
# ---
...
COLUMNS = {
    ...
    "flu_rt": "등락률",
    "trde_tern_rt": "거래회전율",
    "2d_avg_tern_rt": "2일 평균 회전율",
    "10d_avg_tern_rt": "10일 평균 회전율",
    "20d_avg_tern_rt": "20일 평균 회전율"
}
...
def get_overseas_turnover_rate_top_etf(
    stex_tp: str | None = '0',
    etf_cat1: str | None = '',
    etf_cat2: str | None = '',
    ...
    """
    미국주식 회전율 상위(ETF)[usa24151] API를 호출합니다.
    ...
    Example:
        >>> result = get_overseas_turnover_rate_top_etf(
        ...     stex_tp='0',
        ...     etf_cat1='',
        ...     etf_cat2='',
        ...     trde_qty_tp='0',
