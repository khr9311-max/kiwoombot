# ---
# api_id: usa20510
# api_name: 미국주식 기간별 등락률상위(주식/업종)
# category: 미국주식
# sub_category: 순위정보
# template: rest
# api_url: /api/us/rkinfo
# menu_path: 미국주식 > 순위정보 > 미국주식 기간별 등락률상위(주식/업종)(usa20510)
# ---
...
def get_overseas_change_rate_top_by_period(
    stex_tp: str | None = '0',
    inds_cd: str | None = '',
    stk_tp: str | None = '0',
    stk_cnd: str | None = '0',
    ...
    """
    미국주식 기간별 등락률상위(주식/업종)[usa20510] API를 호출합니다.
    ...
    Example:
        >>> result = get_overseas_change_rate_top_by_period(
        ...     stex_tp='0',
        ...     inds_cd='',
        ...     stk_tp='0',
        ...     stk_cnd='0',
