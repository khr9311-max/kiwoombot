# ---
# api_id: usa24291
# api_name: 미국주식 주간거래 괴리율 상위(ETF)
# category: 미국주식
# sub_category: 순위정보
# template: rest
# api_url: /api/us/rkinfo
# menu_path: 미국주식 > 순위정보 > 미국주식 주간거래 괴리율 상위(ETF)(usa24291)
# ---
...
def get_overseas_day_session_disparity_top_etf(
    stex_tp: str | None = '',
    etf_cat1: str | None = '',
    etf_cat2: str | None = '',
    stk_cnd: str | None = '',
    ...
    """
    미국주식 주간거래 괴리율 상위(ETF)[usa24291] API를 호출합니다.
    ...
    Example:
        >>> result = get_overseas_day_session_disparity_top_etf(
        ...     stex_tp='',
        ...     etf_cat1='',
        ...     etf_cat2='',
        ...     stk_cnd='',
