# ---
# api_id: usa20911
# api_name: 미국주식 전일대비 등락률상위(ETF)
# category: 미국주식
# sub_category: 순위정보
# template: rest
# api_url: /api/us/rkinfo
# menu_path: 미국주식 > 순위정보 > 미국주식 전일대비 등락률상위(ETF)(usa20911)
# ---
...
def get_overseas_change_rate_top_vs_prev_day_etf(
    stex_tp: str | None = '0',
    etf_cat1: str | None = '',
    etf_cat2: str | None = '',
    sort_tp: str | None = '1',
    ...
    """
    미국주식 전일대비 등락률상위(ETF)[usa20911] API를 호출합니다.
    ...
    Example:
        >>> result = get_overseas_change_rate_top_vs_prev_day_etf(
        ...     stex_tp='0',
        ...     etf_cat1='',
        ...     etf_cat2='',
        ...     sort_tp='1',
