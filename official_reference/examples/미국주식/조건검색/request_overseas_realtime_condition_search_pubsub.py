...
async def request_overseas_realtime_condition_search_pubsub(
    trnm: str,
    seq: str,
    search_type: str,
    ...
    """
    미국주식 조건검색 요청 실시간[usa20290] WebSocket 메시지를 Pub/Sub로 분배합니다.
...
async def main() -> None:
    ...
    await request_overseas_realtime_condition_search_pubsub(
        trnm='GCNSRREQ',
        seq='0',
        search_type='1',
        max_messages=10,
