# ---
# api_id: usa20280
# api_name: 미국주식 조건검색 목록조회
# category: 미국주식
# sub_category: 조건검색
# template: websocket_request_once
# api_url: /api/us/websocket
# menu_path: 미국주식 > 조건검색 > 미국주식 조건검색 목록조회(usa20280)
# ---
...
async def list_overseas_condition_searches(
    ...
    Example:
        >>> result = await list_overseas_condition_searches(
        ...     trnm='GCNSRLST',
        ... )
