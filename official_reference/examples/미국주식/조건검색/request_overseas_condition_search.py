...
# ---
# api_id: usa20281
# api_name: 미국주식 조건검색 요청 일반
# category: 미국주식
# sub_category: 조건검색
# template: websocket_request_once
# api_url: /api/us/websocket
# menu_path: 미국주식 > 조건검색 > 미국주식 조건검색 요청 일반(usa20281)
# ---
...
async def request_overseas_condition_search(
    trnm: str,
    seq: str,
    search_type: str,
    cont_yn: str | None = 'N',
    ...
    """
    미국주식 조건검색 요청 일반[usa20281] API를 호출합니다.
    ...
    Example:
        >>> result = await request_overseas_condition_search(
        ...     trnm='GCNSRREQ',
        ...     seq='0',
        ...     search_type='0',
        ...     cont_yn='N',
