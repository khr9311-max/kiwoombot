# ---
# api_id: ust21180
# api_name: 미국주식 기간별 주문내역
# category: 미국주식
# sub_category: 계좌
# template: rest
# api_url: /api/us/acnt
# menu_path: 미국주식 > 계좌 > 미국주식 기간별 주문내역(ust21180)
# ---
...
def get_overseas_orders_by_period(
    strt_dt: str,
    end_dt: str,
    slby_tp: str | None = '',
    stex_tp: str | None = '',
    ...
    """
    미국주식 기간별 주문내역[ust21180] API를 호출합니다.

    공통 클라이언트가 유효한 캐시 토큰을 사용하거나 필요 시 자동으로 발급합니다.

    Args:
        strt_dt: 시작주문일자 — YYYYMMDD
        end_dt: 종료주문일자 — YYYYMMDD
        slby_tp: 매도수구분 — 0:전체(기본값),1:매도,2:매수
    ...
    Example:
        >>> result = get_overseas_orders_by_period(
        ...     strt_dt='20260501',
        ...     end_dt='20260528',
        ...     slby_tp='',
        ...     stex_tp='',
    ...
    # 2. 요청 파라미터 바디
    body = {
        "strt_dt": strt_dt,  # 시작주문일자
        "end_dt": end_dt,  # 종료주문일자
    }
    if slby_tp is not None:
        body["slby_tp"] = slby_tp  # 매도수구분
