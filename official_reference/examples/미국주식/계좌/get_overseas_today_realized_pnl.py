# ---
# api_id: ust21630
# api_name: 미국주식 당일 실현손익
# category: 미국주식
# sub_category: 계좌
# template: rest
# api_url: /api/us/acnt
# menu_path: 미국주식 > 계좌 > 미국주식 당일 실현손익(ust21630)
# ---
...
SUMMARY_KEY = "요약"
SUMMARY_COLUMNS = {
    "tot_tdy_pl_amt": "총당일실현손익",
    "tot_tdy_pl_amt_krw": "총당일실현손익(원)"
}
...
def get_overseas_today_realized_pnl(
    fc_krw_tp: str,
    stex_tp: str | None = '',
    stk_cd: str | None = '',
) -> dict[str, pd.DataFrame]:
    """
    미국주식 당일 실현손익[ust21630] API를 호출합니다.
    ...
    Example:
        >>> result = get_overseas_today_realized_pnl(
        ...     fc_krw_tp='0',
        ...     stex_tp='',
        ...     stk_cd='',
        ... )
