# ---
# api_id: ust21120
# api_name: 통화별 예수금 및 증권 평가금현황
# category: 미국주식
# sub_category: 계좌
# template: rest
# api_url: /api/us/acnt
# menu_path: 미국주식 > 계좌 > 통화별 예수금 및 증권 평가금현황(ust21120)
# ---
...
def get_overseas_deposit_and_valuation_by_currency(
    cmsn_incl_tp: str | None = '',
    exrt_tp: str | None = '',
) -> dict[str, pd.DataFrame]:
    """
    통화별 예수금 및 증권 평가금현황[ust21120] API를 호출합니다.
    ...
    Example:
        >>> result = get_overseas_deposit_and_valuation_by_currency(
        ...     cmsn_incl_tp='',
        ...     exrt_tp='',
        ... )
