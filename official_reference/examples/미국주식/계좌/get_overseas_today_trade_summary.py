# ---
# api_id: ust21620
# api_name: 미국주식 당일매매정리
# category: 미국주식
# sub_category: 계좌
# template: rest
# api_url: /api/us/acnt
# menu_path: 미국주식 > 계좌 > 미국주식 당일매매정리(ust21620)
# ---
...
def get_overseas_today_trade_summary(
    fc_krw_tp: str,
    stex_tp: str | None = '',
    stk_cd: str | None = '',
) -> dict[str, pd.DataFrame]:
    """
    미국주식 당일매매정리[ust21620] API를 호출합니다.
    ...
    Example:
        >>> result = get_overseas_today_trade_summary(
        ...     fc_krw_tp='0',
        ...     stex_tp='',
        ...     stk_cd='',
        ... )
