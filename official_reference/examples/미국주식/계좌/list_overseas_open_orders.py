# ---
# api_id: ust21050
# api_name: 미국주식 원장 미체결
# category: 미국주식
# sub_category: 계좌
# template: rest
# api_url: /api/us/acnt
# menu_path: 미국주식 > 계좌 > 미국주식 원장 미체결(ust21050)
# ---
...
def list_overseas_open_orders(
    ...
    """
    미국주식 원장 미체결[ust21050] API를 호출합니다.

    공통 클라이언트가 유효한 캐시 토큰을 사용하거나 필요 시 자동으로 발급합니다.

    Args:
        ord_dt: 주문일자 — 미입력시 오늘 날짜로 조회
        slby_tp: 매도매수구분 — 0:전체(기본값),1:매도,2:매수
        stex_tp: 거래소구분 — 미입력시 전체, ND:NASDAQ,NY:NYSE,NA:AMEX
        stk_cd: 종목코드 — 미입력시 전체
    ...
    Example:
        >>> result = list_overseas_open_orders(
        ...     ord_dt='',
        ...     slby_tp='0',
        ...     stex_tp='',
        ...     stk_cd='',
