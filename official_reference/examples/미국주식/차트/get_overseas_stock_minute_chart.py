...
# menu_path: 미국주식 > 차트 > 미국주식 분 차트(usa06011)
# ---
...
def get_overseas_stock_minute_chart(
    stex_tp: str,
    stk_cd: str | None = 'NVDA',
    strt_dt: str | None = '20260305',
    tic_scope: str | None = '1',
    upd_stkpc_tp: str | None = '0',
    exrt_appl_tp: str | None = '1',
) -> dict[str, pd.DataFrame]:
    """
    미국주식 분 차트[usa06011] API를 호출합니다.
    ...
    Example:
        >>> result = get_overseas_stock_minute_chart(
        ...     stex_tp='ND',
        ...     stk_cd='NVDA',
        ...     strt_dt='20260305',
        ...     tic_scope='1',
    ...
    if tic_scope is not None:
        body["tic_scope"] = tic_scope  # XX분봉
