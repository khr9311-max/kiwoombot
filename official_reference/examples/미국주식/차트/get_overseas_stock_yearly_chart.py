...
# menu_path: 미국주식 > 차트 > 미국주식 년 차트(usa06015)
# ---
...
def get_overseas_stock_yearly_chart(
    stex_tp: str,
    stk_cd: str | None = 'NVDA',
    strt_dt: str | None = '20260402',
    upd_stkpc_tp: str | None = '',
    exrt_appl_tp: str | None = '0',
) -> dict[str, pd.DataFrame]:
    """
    미국주식 년 차트[usa06015] API를 호출합니다.
    ...
    Example:
        >>> result = get_overseas_stock_yearly_chart(
        ...     stex_tp='ND',
        ...     stk_cd='NVDA',
        ...     strt_dt='20260402',
        ...     upd_stkpc_tp='',
