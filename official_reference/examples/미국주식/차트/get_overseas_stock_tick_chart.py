...
# menu_path: 미국주식 > 차트 > 미국주식 틱 차트(usa06010)
# ---
...
def get_overseas_stock_tick_chart(
    stex_tp: str,
    stk_cd: str,
    ...
    Example:
        >>> result = get_overseas_stock_tick_chart(
        ...     stex_tp='ND',
        ...     stk_cd='NVDA',
        ...     tic_scope='1',
        ...     upd_stkpc_tp='1',
