...
# menu_path: 미국주식 > 차트 > 미국주식 일 차트(usa06012)
# ---
...
def get_overseas_stock_daily_chart(
    stex_tp: str,
    stk_cd: str | None = 'NVDA',
    strt_dt: str | None = '20260412',
    upd_stkpc_tp: str | None = '1',
    exrt_appl_tp: str | None = '0',
) -> dict[str, pd.DataFrame]:
    """
    미국주식 일 차트[usa06012] API를 호출합니다.
    ...
    Example:
        >>> result = get_overseas_stock_daily_chart(
        ...     stex_tp='ND',
        ...     stk_cd='NVDA',
        ...     strt_dt='20260412',
        ...     upd_stkpc_tp='1',
