...
# template: rest
# api_url: /api/us/ordr
# menu_path: 미국주식 > 주문 > 미국주식 매수 주문(ust20000)
# ---
...
def buy_overseas_stock(
    stex_tp: str,
    stk_cd: str,
    ord_qty: str,
    trde_tp: str,
    ord_uv: str | None = '213.04',
) -> pd.DataFrame:
    """
    미국주식 매수 주문[ust20000] API를 호출합니다.
    ...
    Args:
        ...
        stk_cd: 종목코드
        ord_qty: 주문수량
        trde_tp: 해외매매구분 — 00:지정가 03시장가 26:VWAP지정가 27:TWAP지정가 30:LOC 36:VWAP시장가 37:TWAP시장가
