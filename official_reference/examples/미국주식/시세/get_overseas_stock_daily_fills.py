# ---
# api_id: usa20151
# api_name: 미국주식 일별 체결내역
# category: 미국주식
# sub_category: 시세
# template: rest
# api_url: /api/us/mrkcond
# menu_path: 미국주식 > 시세 > 미국주식 일별 체결내역(usa20151)
# ---
...
def get_overseas_stock_daily_fills(
    stex_tp: str,
    stk_cd: str,
    base_dt: str | None = '',
) -> dict[str, pd.DataFrame]:
    """
    미국주식 일별 체결내역[usa20151] API를 호출합니다.
    ...
    Example:
        >>> result = get_overseas_stock_daily_fills(
        ...     stex_tp='ND',
        ...     stk_cd='NVDA',
        ...     base_dt='',
        ... )
