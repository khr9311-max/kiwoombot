# ---
# api_id: usa24221
# api_name: 미국주식 매물대집중(ETF)
# category: 미국주식
# sub_category: 종목정보
# template: rest
# api_url: /api/us/stkinfo
# menu_path: 미국주식 > 종목정보 > 미국주식 매물대집중(ETF)(usa24221)
# ---
...
def get_overseas_supply_concentration_etf(
    stex_tp: str | None = '0',
    etf_cat1: str | None = '',
    etf_cat2: str | None = '',
    dt: str | None = '50',
    prps_cnctr_rt: str | None = '50',
    cond: str | None = '0',
    prpscnt: str | None = '10',
    ...
    """
    미국주식 매물대집중(ETF)[usa24221] API를 호출합니다.
    ...
    Args:
        ...
        dt: 기간 — n일, 최대 300일
        prps_cnctr_rt: 매물대 집중비율 — n%, 최대 100%
        cond: 조건 — 0:전체,1:현재가 매물대 진입,2:현재가 매물대 위,3:현재가 매물대 아래
        prpscnt: 매물대수 — n 매물대수, 최대 99
    ...
    Example:
        >>> result = get_overseas_supply_concentration_etf(
        ...     stex_tp='0',
        ...     etf_cat1='',
        ...     etf_cat2='',
        ...     dt='50',
    ...
    if dt is not None:
        body["dt"] = dt  # 기간
    if prps_cnctr_rt is not None:
        body["prps_cnctr_rt"] = prps_cnctr_rt  # 매물대 집중비율
    if cond is not None:
        body["cond"] = cond  # 조건
    if prpscnt is not None:
        body["prpscnt"] = prpscnt  # 매물대수
