# ---
# api_id: usa24210
# api_name: 미국주식 잔량률급증(주식/업종)
# category: 미국주식
# sub_category: 종목정보
# template: rest
# api_url: /api/us/stkinfo
# menu_path: 미국주식 > 종목정보 > 미국주식 잔량률급증(주식/업종)(usa24210)
# ---
...
def get_overseas_remaining_order_ratio_surge(
    stex_tp: str | None = '0',
    inds_cd: str | None = '',
    rt_tp: str | None = '0',
    stk_tp: str | None = '0',
    ...
    """
    미국주식 잔량률급증(주식/업종)[usa24210] API를 호출합니다.
    ...
    Example:
        >>> result = get_overseas_remaining_order_ratio_surge(
        ...     stex_tp='0',
        ...     inds_cd='',
        ...     rt_tp='0',
        ...     stk_tp='0',
