# ---
# api_id: usa20930
# api_name: 미국주식 가격급등락(주식/업종)
# category: 미국주식
# sub_category: 종목정보
# template: rest
# api_url: /api/us/stkinfo
# menu_path: 미국주식 > 종목정보 > 미국주식 가격급등락(주식/업종)(usa20930)
# ---
...
def get_overseas_price_surge_drop(
    stex_tp: str | None = '0',
    stk_tp: str | None = '0',
    inds_cd: str | None = '',
    stk_cnd: str | None = '1',
    ...
    """
    미국주식 가격급등락(주식/업종)[usa20930] API를 호출합니다.
    ...
    Example:
        >>> result = get_overseas_price_surge_drop(
        ...     stex_tp='0',
        ...     stk_tp='0',
        ...     inds_cd='',
        ...     stk_cnd='1',
