# ---
# api_id: usa23401
# api_name: 미국주식 거래량갱신(ETF)
# category: 미국주식
# sub_category: 종목정보
# template: rest
# api_url: /api/us/stkinfo
# menu_path: 미국주식 > 종목정보 > 미국주식 거래량갱신(ETF)(usa23401)
# ---
...
def get_overseas_volume_renewal_etf(
    stex_tp: str | None = '0',
    etf_cat1: str | None = '',
    etf_cat2: str | None = '',
    ...
    """
    미국주식 거래량갱신(ETF)[usa23401] API를 호출합니다.
    ...
    Example:
        >>> result = get_overseas_volume_renewal_etf(
        ...     stex_tp='0',
        ...     etf_cat1='',
        ...     etf_cat2='',
        ...     trde_qty_tp='0',
