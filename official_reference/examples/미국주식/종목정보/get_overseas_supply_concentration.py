# ---
# api_id: usa24220
# api_name: 미국주식 매물대집중(주식/업종)
# category: 미국주식
# sub_category: 종목정보
# template: rest
# api_url: /api/us/stkinfo
# menu_path: 미국주식 > 종목정보 > 미국주식 매물대집중(주식/업종)(usa24220)
# ---
...
def get_overseas_supply_concentration(
    stex_tp: str | None = '0',
    inds_cd: str | None = '',
    stk_tp: str | None = '0',
    dt: str | None = '50',
    ...
    """
    미국주식 매물대집중(주식/업종)[usa24220] API를 호출합니다.
    ...
    Example:
        >>> result = get_overseas_supply_concentration(
        ...     stex_tp='0',
        ...     inds_cd='',
        ...     stk_tp='0',
        ...     dt='50',
