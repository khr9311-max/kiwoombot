# ---
# api_id: usa20521
# api_name: 미국주식 거래량급등락(ETF)
# category: 미국주식
# sub_category: 종목정보
# template: rest
# api_url: /api/us/stkinfo
# menu_path: 미국주식 > 종목정보 > 미국주식 거래량급등락(ETF)(usa20521)
# ---
...
def get_overseas_volume_surge_drop_etf(
    stex_tp: str | None = '0',
    tm: str | None = '5',
    etf_cat1: str | None = '',
    etf_cat2: str | None = '',
    ...
    """
    미국주식 거래량급등락(ETF)[usa20521] API를 호출합니다.
    ...
    Example:
        >>> result = get_overseas_volume_surge_drop_etf(
        ...     stex_tp='0',
        ...     tm='5',
        ...     etf_cat1='',
        ...     etf_cat2='',
