# ---
# api_id: usa23402
# api_name: 미국주식 거래량갱신(관심종목)
# category: 미국주식
# sub_category: 종목정보
# template: rest
# api_url: /api/us/stkinfo
# menu_path: 미국주식 > 종목정보 > 미국주식 거래량갱신(관심종목)(usa23402)
# ---
...
def get_overseas_volume_renewal_watchlist(
    stex_tp: str | None = '0',
    ...
    """
    미국주식 거래량갱신(관심종목)[usa23402] API를 호출합니다.
    ...
    Example:
        >>> result = get_overseas_volume_renewal_watchlist(
        ...     stex_tp='0',
