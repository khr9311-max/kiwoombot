# ---
# api_id: usa24100
# api_name: 미국주식 신고가/신저가(주식/업종)
# category: 미국주식
# sub_category: 종목정보
# template: rest
# api_url: /api/us/stkinfo
# menu_path: 미국주식 > 종목정보 > 미국주식 신고가/신저가(주식/업종)(usa24100)
# ---
...
def get_overseas_new_high_low(
    ...
    """
    미국주식 신고가/신저가(주식/업종)[usa24100] API를 호출합니다.
    ...
    Example:
        >>> result = get_overseas_new_high_low(
        ...     stex_tp='0',
        ...     stk_tp='0',
        ...     inds_cd='',
        ...     stk_cnd='0',
