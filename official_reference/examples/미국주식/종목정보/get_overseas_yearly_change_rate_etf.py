# ---
# api_id: usa26414
# api_name: 미국주식 연도별 등락률(ETF)
# category: 미국주식
# sub_category: 종목정보
# template: rest
# api_url: /api/us/stkinfo
# menu_path: 미국주식 > 종목정보 > 미국주식 연도별 등락률(ETF)(usa26414)
# ---
...
def get_overseas_yearly_change_rate_etf(
    etf_cat1: str | None = '',
    etf_cat2: str | None = '',
) -> dict[str, pd.DataFrame]:
    """
    미국주식 연도별 등락률(ETF)[usa26414] API를 호출합니다.
    ...
    Example:
        >>> result = get_overseas_yearly_change_rate_etf(
        ...     etf_cat1='',
        ...     etf_cat2='',
        ... )
