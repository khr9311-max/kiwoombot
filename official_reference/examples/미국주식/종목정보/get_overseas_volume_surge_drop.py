# ---
# api_id: usa20520
# api_name: 미국주식 거래량급등락(주식/업종)
# category: 미국주식
# sub_category: 종목정보
# template: rest
# api_url: /api/us/stkinfo
# menu_path: 미국주식 > 종목정보 > 미국주식 거래량급등락(주식/업종)(usa20520)
# ---
...
def get_overseas_volume_surge_drop(
    stex_tp: str | None = '0',
    inds_cd: str | None = '',
    tm: str | None = '5',
    stk_tp: str | None = '0',
    ...
    """
    미국주식 거래량급등락(주식/업종)[usa20520] API를 호출합니다.

    공통 클라이언트가 유효한 캐시 토큰을 사용하거나 필요 시 자동으로 발급합니다.

    Args:
        stex_tp: 거래소구분 — 0:전체,1:NYSE,2:NASDAQ,3:AMEX
        inds_cd: 업종코드 — usa10101 API 참고, stk_tp(종목구분) 1일 경우
        tm: x일평균대비 — 5일, 10일, 20일, 30일
    ...
    Example:
        >>> result = get_overseas_volume_surge_drop(
        ...     stex_tp='0',
        ...     inds_cd='',
        ...     tm='5',
        ...     stk_tp='0',
