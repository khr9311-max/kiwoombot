# ---
# api_id: usa20971
# api_name: 미국주식 고가/저가 접근(ETF)
# category: 미국주식
# sub_category: 종목정보
# template: rest
# api_url: /api/us/stkinfo
# menu_path: 미국주식 > 종목정보 > 미국주식 고가/저가 접근(ETF)(usa20971)
# ---
...
def get_overseas_high_low_proximity_etf(
    stex_tp: str | None = '0',
    etf_cat1: str | None = '',
    etf_cat2: str | None = '',
    ...
    """
    미국주식 고가/저가 접근(ETF)[usa20971] API를 호출합니다.
    ...
    Example:
        >>> result = get_overseas_high_low_proximity_etf(
        ...     stex_tp='0',
        ...     etf_cat1='',
        ...     etf_cat2='',
        ...     high_low_tp='1',
