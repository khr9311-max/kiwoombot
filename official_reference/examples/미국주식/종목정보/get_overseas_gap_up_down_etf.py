# ---
# api_id: usa24141
# api_name: 미국주식 갭상승/갭하락(ETF)
# category: 미국주식
# sub_category: 종목정보
# template: rest
# api_url: /api/us/stkinfo
# menu_path: 미국주식 > 종목정보 > 미국주식 갭상승/갭하락(ETF)(usa24141)
# ---
...
def get_overseas_gap_up_down_etf(
    stex_tp: str | None = '0',
    etf_cat1: str | None = '',
    etf_cat2: str | None = '',
    sort_tp: str | None = '0',
    updown_tp: str | None = '0',
    alacc_rt: str | None = '3',
    stk_cnd: str | None = '0',
    pric_cnd: str | None = '0',
    ...
    """
    미국주식 갭상승/갭하락(ETF)[usa24141] API를 호출합니다.
    ...
    Args:
        ...
        sort_tp: 정렬기준 — 1:갭비율, 2:전일대비
        updown_tp: 등락구분 — 1:갭상승, 2:갭하락
        alacc_rt: 비율1(근접율) — 갭비율 값(3:3%이상,5:5%이상,10:10%이상,10:10%이상,50:50%이상,100:100%이상,150:150%이상,200:200%이상)
        stk_cnd: 종목조건 — 0:전체,1:증거금100%,2:증거금50%
    ...
    Example:
        >>> result = get_overseas_gap_up_down_etf(
        ...     stex_tp='0',
        ...     etf_cat1='',
        ...     etf_cat2='',
        ...     sort_tp='0',
    ...
    if updown_tp is not None:
        body["updown_tp"] = updown_tp  # 등락구분
    if alacc_rt is not None:
        body["alacc_rt"] = alacc_rt  # 비율1(근접율)
