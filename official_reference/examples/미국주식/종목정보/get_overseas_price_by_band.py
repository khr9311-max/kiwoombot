# ---
# api_id: usa20570
# api_name: 미국주식 가격대별주가(주식/업종)
# category: 미국주식
# sub_category: 종목정보
# template: rest
# api_url: /api/us/stkinfo
# menu_path: 미국주식 > 종목정보 > 미국주식 가격대별주가(주식/업종)(usa20570)
# ---
...
def get_overseas_price_by_band(
    stex_tp: str | None = '0',
    stk_tp: str | None = '0',
    stk_cnd: str | None = '0',
    inds_cd: str | None = '',
    ...
    """
    미국주식 가격대별주가(주식/업종)[usa20570] API를 호출합니다.
    ...
    Example:
        >>> result = get_overseas_price_by_band(
        ...     stex_tp='0',
        ...     stk_tp='0',
        ...     stk_cnd='0',
        ...     inds_cd='',
