# ---
# api_id: usa24101
# api_name: 미국주식 신고가/신저가(ETF)
# category: 미국주식
# sub_category: 종목정보
# template: rest
# api_url: /api/us/stkinfo
# menu_path: 미국주식 > 종목정보 > 미국주식 신고가/신저가(ETF)(usa24101)
# ---
...
def get_overseas_new_high_low_etf(
    stex_tp: str | None = '0',
    etf_cat1: str | None = '',
    etf_cat2: str | None = '',
    stk_cnd: str | None = '0',
    ...
    """
    미국주식 신고가/신저가(ETF)[usa24101] API를 호출합니다.
    ...
    Args:
        ...
        ntl_tp: 신고가신저가구분 — 1:신고가, 2:신저가
        high_low_tp: 고저기준 — 1:고가저가기준,2:종가기준
        dt: 기간입력 — n일 기간(최대250), 일자구분과 동시사용 안됨
    ...
    Example:
        >>> result = get_overseas_new_high_low_etf(
        ...     stex_tp='0',
        ...     etf_cat1='',
        ...     etf_cat2='',
        ...     stk_cnd='0',
    ...
    if ntl_tp is not None:
        body["ntl_tp"] = ntl_tp  # 신고가신저가구분
    if high_low_tp is not None:
        body["high_low_tp"] = high_low_tp  # 고저기준
    if dt is not None:
        body["dt"] = dt  # 기간입력
