# ---
# api_id: usa24140
# api_name: 미국주식 갭상승/갭하락(주식/업종)
# category: 미국주식
# sub_category: 종목정보
# template: rest
# api_url: /api/us/stkinfo
# menu_path: 미국주식 > 종목정보 > 미국주식 갭상승/갭하락(주식/업종)(usa24140)
# ---
...
def get_overseas_gap_up_down(
    ...
    """
    미국주식 갭상승/갭하락(주식/업종)[usa24140] API를 호출합니다.
    ...
    Example:
        >>> result = get_overseas_gap_up_down(
        ...     stex_tp='0',
        ...     inds_cd='',
        ...     stk_tp='',
        ...     sort_tp='0',
