# ---
# api_id: usa20571
# api_name: 미국주식 가격대별주가(ETF)
# category: 미국주식
# sub_category: 종목정보
# template: rest
# api_url: /api/us/stkinfo
# menu_path: 미국주식 > 종목정보 > 미국주식 가격대별주가(ETF)(usa20571)
# ---
...
def get_overseas_price_by_band_etf(
    stex_tp: str | None = '0',
    stk_cnd: str | None = '0',
    etf_cat1: str | None = '',
    etf_cat2: str | None = '',
    trde_qty_tp: str | None = '0',
    pric_cnd1: str | None = '5',
    pric_cnd2: str | None = '20',
    trde_prica_cnd: str | None = '0',
) -> dict[str, pd.DataFrame]:
    """
    미국주식 가격대별주가(ETF)[usa20571] API를 호출합니다.
    ...
    Args:
        ...
        pric_cnd1: 가격조건1 — 최대 999999.99
        pric_cnd2: 가격조건2 — 최대 999999.99
    ...
    Example:
        >>> result = get_overseas_price_by_band_etf(
        ...     stex_tp='0',
        ...     stk_cnd='0',
        ...     etf_cat1='',
        ...     etf_cat2='',
    ...
    if pric_cnd1 is not None:
        body["pric_cnd1"] = pric_cnd1  # 가격조건1
    if pric_cnd2 is not None:
        body["pric_cnd2"] = pric_cnd2  # 가격조건2
