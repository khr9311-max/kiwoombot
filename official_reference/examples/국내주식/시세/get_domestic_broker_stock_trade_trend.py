...
# menu_path: 국내주식 > 시세 > 증권사별종목매매동향요청(ka10078)
# ---
...
def get_domestic_broker_stock_trade_trend(
    mmcm_cd: str,
    stk_cd: str,
    strt_dt: str,
    end_dt: str,
    ...
    """
    증권사별종목매매동향요청[ka10078] API를 호출합니다.
    ...
    Example:
        >>> result = get_domestic_broker_stock_trade_trend(
        ...     mmcm_cd='001',
        ...     stk_cd='005930',
        ...     strt_dt='20241106',
        ...     end_dt='20241107',
