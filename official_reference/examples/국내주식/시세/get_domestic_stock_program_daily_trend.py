# ---
# api_id: ka90013
# api_name: 종목일별프로그램매매추이요청
# category: 국내주식
# sub_category: 시세
# template: rest
# api_url: /api/dostk/mrkcond
# menu_path: 국내주식 > 시세 > 종목일별프로그램매매추이요청(ka90013)
# ---
...
TABLE_KEYS = {
    "stk_daly_prm_trde_trnsn": "종목일별프로그램매매추이"
}
COLUMNS = {
    "dt": "일자",
    "cur_prc": "현재가",
...
def get_domestic_stock_program_daily_trend(
    stk_cd: str,
    amt_qty_tp: str | None = '',
    date: str | None = '',
) -> dict[str, pd.DataFrame]:
    """
    종목일별프로그램매매추이요청[ka90013] API를 호출합니다.
    ...
    Example:
        >>> result = get_domestic_stock_program_daily_trend(
        ...     stk_cd='005930',
        ...     amt_qty_tp='',
        ...     date='',
        ... )
