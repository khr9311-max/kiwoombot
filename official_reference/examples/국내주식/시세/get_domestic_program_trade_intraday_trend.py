...
# menu_path: 국내주식 > 시세 > 프로그램매매추이요청 시간대별(ka90005)
# ---
...
def get_domestic_program_trade_intraday_trend(
    date: str,
    amt_qty_tp: str,
    mrkt_tp: str,
    min_tic_tp: str,
    ...
    """
    프로그램매매추이요청 시간대별[ka90005] API를 호출합니다.
    ...
    Example:
        >>> result = get_domestic_program_trade_intraday_trend(
        ...     date='20241101',
        ...     amt_qty_tp='1',
        ...     mrkt_tp='P00101',
        ...     min_tic_tp='1',
