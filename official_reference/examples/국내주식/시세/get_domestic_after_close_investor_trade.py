...
# menu_path: 국내주식 > 시세 > 장마감후투자자별매매요청(ka10066)
# ---
...
def get_domestic_after_close_investor_trade(
    mrkt_tp: str,
    amt_qty_tp: str,
    trde_tp: str,
    stex_tp: str,
    ...
    """
    장마감후투자자별매매요청[ka10066] API를 호출합니다.
    ...
    Example:
        >>> result = get_domestic_after_close_investor_trade(
        ...     mrkt_tp='000',
        ...     amt_qty_tp='1',
        ...     trde_tp='0',
        ...     stex_tp='3',
