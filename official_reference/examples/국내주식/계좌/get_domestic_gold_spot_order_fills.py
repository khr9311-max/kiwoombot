...
# menu_path: 국내주식 > 계좌 > 금현물 주문체결조회(kt50031)
# ---
...
def get_domestic_gold_spot_order_fills(
    qry_tp: str,
    stk_bond_tp: str,
    sell_tp: str,
    dmst_stex_tp: str,
    ord_dt: str | None = '20250821',
    stk_cd: str | None = 'M04020000',
    fr_ord_no: str | None = '',
) -> dict[str, pd.DataFrame]:
    """
    금현물 주문체결조회[kt50031] API를 호출합니다.
    ...
    Example:
        >>> result = get_domestic_gold_spot_order_fills(
        ...     qry_tp='1',
        ...     stk_bond_tp='0',
        ...     sell_tp='0',
        ...     dmst_stex_tp='%',
