...
# menu_path: 국내주식 > ELW > ELWLP보유일별추이요청(ka30003)
# ---
...
def get_domestic_elw_lp_daily_holding_trend(
    bsis_aset_cd: str,
    base_dt: str,
) -> dict[str, pd.DataFrame]:
    """
    ELWLP보유일별추이요청[ka30003] API를 호출합니다.
    ...
    Example:
        >>> result = get_domestic_elw_lp_daily_holding_trend(
        ...     bsis_aset_cd='57KJ99',
        ...     base_dt='20241122',
        ... )
