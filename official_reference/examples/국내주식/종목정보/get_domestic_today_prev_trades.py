...
# menu_path: 국내주식 > 종목정보 > 당일전일체결요청(ka10084)
# ---
...
def get_domestic_today_prev_trades(
    stk_cd: str,
    tdy_pred: str,
    tic_min: str,
    tm: str | None = '',
    ...
    if not tdy_pred:
        raise ValueError('tdy_pred is required.')
    if not tic_min:
        raise ValueError('tic_min is required.')
