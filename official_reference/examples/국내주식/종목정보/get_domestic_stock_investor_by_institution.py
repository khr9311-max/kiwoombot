...
# menu_path: 국내주식 > 종목정보 > 종목별투자자기관별요청(ka10059)
# ---
...
def get_domestic_stock_investor_by_institution(
    dt: str,
    stk_cd: str,
    amt_qty_tp: str,
    trde_tp: str,
    ...
    """
    종목별투자자기관별요청[ka10059] API를 호출합니다.
    ...
    Example:
        >>> result = get_domestic_stock_investor_by_institution(
        ...     dt='20241107',
        ...     stk_cd='005930',
        ...     amt_qty_tp='1',
        ...     trde_tp='0',
