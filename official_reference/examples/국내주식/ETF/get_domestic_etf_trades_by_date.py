...
# menu_path: 국내주식 > ETF > ETF일자별체결요청(ka40008)
# ---
...
TABLE_KEYS = {
    "etfnetprps_qty_array": "ETF순매수수량배열"
}
COLUMNS = {
    "dt": "일자",
    "cur_prc_n": "현재가n",
...
def get_domestic_etf_trades_by_date(
    stk_cd: str,
) -> dict[str, pd.DataFrame]:
    """
    ETF일자별체결요청[ka40008] API를 호출합니다.
    ...
    Example:
        >>> result = get_domestic_etf_trades_by_date(
        ...     stk_cd='069500',
        ... )
