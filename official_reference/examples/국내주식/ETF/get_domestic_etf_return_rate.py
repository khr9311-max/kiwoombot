...
# menu_path: 국내주식 > ETF > ETF수익율요청(ka40001)
# ---
...
def get_domestic_etf_return_rate(
    stk_cd: str,
    etfobjt_idex_cd: str,
    dt: str,
) -> dict[str, pd.DataFrame]:
    """
    ETF수익율요청[ka40001] API를 호출합니다.
    ...
    if not etfobjt_idex_cd:
        raise ValueError('etfobjt_idex_cd is required.')
    if not dt:
