...
# menu_path: 국내주식 > ETF > ETF시간대별체결요청(ka40007)
# ---
...
TABLE_KEYS = {
    "etftisl_cntr_array": "ETF시간대별체결배열"
}
COLUMNS = {
    "cntr_tm": "체결시간",
    "cur_prc": "현재가",
...
def get_domestic_etf_intraday_trades(
    stk_cd: str,
) -> dict[str, pd.DataFrame]:
    """
    ETF시간대별체결요청[ka40007] API를 호출합니다.
    ...
    Example:
        >>> result = get_domestic_etf_intraday_trades(
        ...     stk_cd='069500',
        ... )
