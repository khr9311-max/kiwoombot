...
# menu_path: 국내주식 > 테마 > 테마구성종목요청(ka90002)
# ---
...
def get_domestic_theme_stocks(
    thema_grp_cd: str,
    stex_tp: str,
    date_tp: str | None = '2',
) -> dict[str, pd.DataFrame]:
    """
    테마구성종목요청[ka90002] API를 호출합니다.
    ...
    # 1. 필수 파라미터 검증
    if not thema_grp_cd:
        raise ValueError('thema_grp_cd is required.')
    if not stex_tp:
