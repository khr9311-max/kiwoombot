...
# menu_path: 국내주식 > 신용주문 > 신용 매도주문(kt10007)
# ---
...
def sell_domestic_credit_stock(
    dmst_stex_tp: str,
    stk_cd: str,
    ord_qty: str,
    trde_tp: str,
    crd_deal_tp: str,
    ord_uv: str | None = '6450',
    crd_loan_dt: str | None = '',
    cond_uv: str | None = '',
) -> pd.DataFrame:
    """
    신용 매도주문[kt10007] API를 호출합니다.
    ...
    if not crd_deal_tp:
        raise ValueError('crd_deal_tp is required.')
