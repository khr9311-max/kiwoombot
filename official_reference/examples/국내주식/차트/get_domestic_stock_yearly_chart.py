...
# menu_path: 국내주식 > 차트 > 주식년봉차트조회요청(ka10094)
# ---
...
TABLE_KEYS = {
    "stk_yr_pole_chart_qry": "주식년봉차트조회"
}
COLUMNS = {
    "cur_prc": "현재가",
    "trde_qty": "거래량",
...
def get_domestic_stock_yearly_chart(
    stk_cd: str,
    base_dt: str,
    upd_stkpc_tp: str,
) -> dict[str, pd.DataFrame]:
    """
    주식년봉차트조회요청[ka10094] API를 호출합니다.
    ...
    Example:
        >>> result = get_domestic_stock_yearly_chart(
        ...     stk_cd='005930',
        ...     base_dt='20250905',
        ...     upd_stkpc_tp='1',
        ... )
