...
# menu_path: 국내주식 > 차트 > 금현물분봉차트조회요청(ka50080)
# ---
...
def get_domestic_gold_spot_minute_chart(
    stk_cd: str,
    tic_scope: str,
    upd_stkpc_tp: str | None = '1',
) -> dict[str, pd.DataFrame]:
    """
    금현물분봉차트조회요청[ka50080] API를 호출합니다.
    ...
    Example:
        >>> result = get_domestic_gold_spot_minute_chart(
        ...     stk_cd='M04020000',
        ...     tic_scope='1',
        ...     upd_stkpc_tp='1',
        ... )
