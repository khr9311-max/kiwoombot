# ---
# api_id: ka50081
# api_name: 금현물일봉차트조회요청
# category: 국내주식
# sub_category: 차트
# template: rest
# api_url: /api/dostk/chart
# menu_path: 국내주식 > 차트 > 금현물일봉차트조회요청(ka50081)
# ---
...
def get_domestic_gold_spot_daily_chart(
    stk_cd: str,
    base_dt: str,
    upd_stkpc_tp: str,
) -> dict[str, pd.DataFrame]:
    """
    금현물일봉차트조회요청[ka50081] API를 호출합니다.
    ...
    Example:
        >>> result = get_domestic_gold_spot_daily_chart(
        ...     stk_cd='M04020000',
        ...     base_dt='20250826',
        ...     upd_stkpc_tp='1',
        ... )
