...
# menu_path: 국내주식 > 차트 > 업종주봉조회요청(ka20007)
# ---
...
def get_domestic_sector_weekly_chart(
    inds_cd: str,
    base_dt: str,
) -> dict[str, pd.DataFrame]:
    """
    업종주봉조회요청[ka20007] API를 호출합니다.
    ...
    Example:
        >>> result = get_domestic_sector_weekly_chart(
        ...     inds_cd='001',
        ...     base_dt='20250905',
        ... )
