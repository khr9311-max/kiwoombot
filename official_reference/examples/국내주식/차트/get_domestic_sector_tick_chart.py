...
# menu_path: 국내주식 > 차트 > 업종틱차트조회요청(ka20004)
# ---
...
def get_domestic_sector_tick_chart(
    inds_cd: str,
    tic_scope: str,
) -> dict[str, pd.DataFrame]:
    """
    업종틱차트조회요청[ka20004] API를 호출합니다.
    ...
    Example:
        >>> result = get_domestic_sector_tick_chart(
        ...     inds_cd='001',
        ...     tic_scope='1',
        ... )
