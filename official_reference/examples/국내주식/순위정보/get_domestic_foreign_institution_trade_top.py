...
# menu_path: 국내주식 > 순위정보 > 외국인기관매매상위요청(ka90009)
# ---
...
def get_domestic_foreign_institution_trade_top(
    mrkt_tp: str,
    amt_qty_tp: str,
    qry_dt_tp: str,
    stex_tp: str,
    date: str | None = '20241101',
) -> dict[str, pd.DataFrame]:
    """
    외국인기관매매상위요청[ka90009] API를 호출합니다.
    ...
    Example:
        >>> result = get_domestic_foreign_institution_trade_top(
        ...     mrkt_tp='000',
        ...     amt_qty_tp='1',
        ...     qry_dt_tp='1',
        ...     stex_tp='1',
