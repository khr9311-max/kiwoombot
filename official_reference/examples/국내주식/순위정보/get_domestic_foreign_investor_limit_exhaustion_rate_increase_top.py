...
# menu_path: 국내주식 > 순위정보 > 외인한도소진율증가상위(ka10036)
# ---
...
def get_domestic_foreign_investor_limit_exhaustion_rate_increase_top(
    mrkt_tp: str,
    dt: str,
    stex_tp: str,
) -> dict[str, pd.DataFrame]:
    """
    외인한도소진율증가상위[ka10036] API를 호출합니다.
