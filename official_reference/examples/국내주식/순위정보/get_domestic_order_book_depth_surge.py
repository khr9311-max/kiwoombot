...
# menu_path: 국내주식 > 순위정보 > 호가잔량급증요청(ka10021)
# ---
...
def get_domestic_order_book_depth_surge(
    mrkt_tp: str,
    trde_tp: str,
    sort_tp: str,
    tm_tp: str,
    ...
    Args:
        ...
        tm_tp: 시간구분 — 분 입력
        trde_qty_tp: 거래량구분 — 1:천주이상, 5:5천주이상, 10:만주이상, 50:5만주이상, 100:10만주이상
    ...
    Example:
        >>> result = get_domestic_order_book_depth_surge(
        ...     mrkt_tp='001',
        ...     trde_tp='1',
        ...     sort_tp='1',
        ...     tm_tp='30',
