...
# menu_path: 국내주식 > 순위정보 > 외국계창구매매상위요청(ka10037)
# ---
...
def get_domestic_foreign_broker_trade_top(
    mrkt_tp: str,
    dt: str,
    trde_tp: str,
    sort_tp: str,
    ...
    """
    외국계창구매매상위요청[ka10037] API를 호출합니다.
    ...
    Args:
        ...
        trde_tp: 매매구분 — 1:순매수, 2:순매도, 3:매수, 4:매도
        sort_tp: 정렬구분 — 1:금액, 2:수량
    ...
    Example:
        >>> result = get_domestic_foreign_broker_trade_top(
        ...     mrkt_tp='000',
        ...     dt='0',
        ...     trde_tp='1',
        ...     sort_tp='2',
