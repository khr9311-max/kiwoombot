...
# menu_path: 국내주식 > 순위정보 > 외인연속순매매상위요청(ka10035)
# ---
...
def get_domestic_foreign_investor_net_buy_streak_top(
    mrkt_tp: str,
    trde_tp: str,
    base_dt_tp: str,
    stex_tp: str,
    ...
    """
    외인연속순매매상위요청[ka10035] API를 호출합니다.
    ...
    if not base_dt_tp:
        raise ValueError('base_dt_tp is required.')
    if not stex_tp:
