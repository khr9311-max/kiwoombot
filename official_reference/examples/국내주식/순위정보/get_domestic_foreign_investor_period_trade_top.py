# ---
# api_id: ka10034
# api_name: 외인기간별매매상위요청
# category: 국내주식
# sub_category: 순위정보
# template: rest
# api_url: /api/dostk/rkinfo
# menu_path: 국내주식 > 순위정보 > 외인기간별매매상위요청(ka10034)
# ---
...
def get_domestic_foreign_investor_period_trade_top(
    mrkt_tp: str,
    trde_tp: str,
    dt: str,
    stex_tp: str,
    ...
    """
    외인기간별매매상위요청[ka10034] API를 호출합니다.

    공통 클라이언트가 유효한 캐시 토큰을 사용하거나 필요 시 자동으로 발급합니다.

    Args:
        mrkt_tp: 시장구분 — 000:전체, 001:코스피, 101:코스닥
        trde_tp: 매매구분 — 1:순매도, 2:순매수, 3:순매매
    ...
    Example:
        >>> result = get_domestic_foreign_investor_period_trade_top(
        ...     mrkt_tp='001',
        ...     trde_tp='2',
        ...     dt='0',
        ...     stex_tp='1',
