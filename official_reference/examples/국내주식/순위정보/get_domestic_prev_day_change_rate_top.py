...
# menu_path: 국내주식 > 순위정보 > 전일대비등락률상위요청(ka10027)
# ---
...
def get_domestic_prev_day_change_rate_top(
    mrkt_tp: str,
    sort_tp: str,
    trde_qty_cnd: str,
    stk_cnd: str,
    ...
    """
    전일대비등락률상위요청[ka10027] API를 호출합니다.
    ...
    Example:
        >>> result = get_domestic_prev_day_change_rate_top(
        ...     mrkt_tp='000',
        ...     sort_tp='1',
        ...     trde_qty_cnd='0000',
        ...     stk_cnd='0',
